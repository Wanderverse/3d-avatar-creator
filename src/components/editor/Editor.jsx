...
import { getClassOptions, getRandomizedTemplateOptions, getTraitOptions } from '@/library/option-utils'
...
export default function Editor({ animationManager, blinkManager, lookatManager, effectManager, fetchNewModel }) {
  ...
  useEffect(() => {
    if (awaitDisplay) {
      setSelectedOptions(loadUserSelection(templateInfo.name) || getRandomizedTemplateOptions(templateInfo))
