...
import manifestJSON from '@/utils/manifest.json'
import personalityJSON from '@/utils/personality.json'
const Overlay = dynamic(() => import('@/components/dom/Overlay').then((mod) => mod.Overlay), { ssr: false })
const Create = dynamic(() => import('@/pages/Create'), { ssr: false })
const Appearance = dynamic(() => import('@/pages/Configurator'), { ssr: false })
...
export default function App() {
  ...
  return (
    <Fragment>
      <div className='bg-transparent mx-auto flex w-full h-full flex-col flex-wrap items-center md:flex-row  lg:w-4/5'>
        <Overlay />
        {/* <LanguageSwitch />
      <Background />
    */}
...
// import Appearance from './pages/Configurator'
// import dynamic from 'next/dynamic'
